...
import { Wallet, LogOut, ArrowRightLeft, Plus, CreditCard } from 'lucide-react';
            ...
            <div className="grid grid-cols-3 gap-2 mb-6">
              {[20, 50, 100, 200, 500].map(amount => (
                <button
                  ...
                  className={`py-3 rounded-2xl font-bold border-2 transition-all ${topUpAmount === amount ? 'border-orange-500 bg-orange-50 text-orange-600' : 'border-gray-100 text-gray-500'
                    }`}
                >
                  {amount}
                </button>
      ...
      <nav className="hidden sm:block bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={toggleMode} className={`px-6 py-3 rounded-2xl font-black text-sm transition-all ${activeMode === 'BUYER' ? 'bg-gray-900 text-white' : 'bg-green-600 text-white'
              }`}>
